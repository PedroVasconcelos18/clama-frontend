      ...
      <main className="max-w-prose mx-auto px-4 py-12">
        <article className="prose prose-lg">
          ...
          <ul className="list-disc pl-6 text-clama-night/80 space-y-2 mb-6">
            ...
            <li><strong>Contribuição:</strong> valor pago pelo Usuário como contraprestação pelo Serviço digital, a partir do mínimo de R$ 6,99 (seis reais e noventa e nove centavos), não configurando doação, dízimo, oferta religiosa ou qualquer obrigação de natureza confessional.</li>
          </ul>
          ...
          <p className="text-clama-night/80 mb-4">
            A Contribuição mínima para acesso ao Serviço é de R$ 6,99 (seis reais e noventa e nove centavos). O Clama disponibiliza opções sugeridas de R$ 6,99, R$ 7,99 e R$ 8,99, além de valor livre a critério do Usuário, sempre observado o mínimo estabelecido. Os pagamentos são processados por plataforma de pagamentos certificada (Asaas), mediante cartão de crédito, débito ou Pix.
          </p>
