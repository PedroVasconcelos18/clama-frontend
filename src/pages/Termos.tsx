      ...
      <main className="max-w-prose mx-auto px-4 py-12">
        <article className="prose prose-lg">
          ...
          <ul className="list-disc pl-6 text-clama-night/80 space-y-2 mb-6">
            ...
            <li><strong>Contribuição:</strong> valor pago pelo Usuário como contraprestação pelo Serviço digital, a partir do mínimo de R$ 1,00 (um real), não configurando doação, dízimo, oferta religiosa ou qualquer obrigação de natureza confessional.</li>
          </ul>
          ...
          <p className="text-clama-night/80 mb-4">
            A Contribuição mínima para acesso ao Serviço é de R$ 1,00 (um real). O Clama disponibiliza planos com valores sugeridos, além de valor livre a critério do Usuário, sempre observado o mínimo estabelecido. Os pagamentos são processados por plataforma de pagamentos certificada (Mercado Pago), via Pix.
          </p>
