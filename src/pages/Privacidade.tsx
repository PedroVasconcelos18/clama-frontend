    ...
    <div className="min-h-screen bg-clama-cream">
      ...
      <main className="max-w-prose mx-auto px-4 py-12">
        <article className="prose prose-lg">
          ...
          <p className="text-clama-night/80 mb-4">
            Os dados de transação são compartilhados com o <strong>Mercado Pago</strong> (Mercado Pago Instituição de Pagamento Ltda.), instituição de pagamento regulamentada pelo Banco Central do Brasil, que atua como operadora de dados nos termos do art. 5º, inciso VII, da LGPD. O tratamento dos dados de pagamento está sujeito às disposições da LGPD e à regulamentação do Banco Central. Essa relação é regida por contrato específico de processamento de dados que impõe ao Mercado Pago obrigações equivalentes às previstas nesta Política. A Clama não tem acesso nem armazena os dados completos de cartão de crédito ou débito processados pelo Mercado Pago.
          </p>
          <p className="text-clama-night/80 mb-4">
          ...
          <p className="text-clama-night/80 mb-4">
            O processamento de pagamentos é realizado pelo Mercado Pago (Mercado Pago Instituição de Pagamento Ltda.), instituição de pagamento regulamentada pelo Banco Central do Brasil. O tratamento dos dados de pagamento está sujeito às disposições da LGPD e à regulamentação aplicável.
          </p>
          <p className="text-clama-night/80 mb-6">
