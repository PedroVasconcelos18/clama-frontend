 ...
 */
export const PedidoSectionGratuito = forwardRef<HTMLElement>((_props, ref) => {
  ...
  return (
    <section ref={ref} id="fazer-pedido" className="bg-white scroll-mt-20">
        ...
        {submitted ? (
          ...
          <>
            ...
            <header className="text-center mb-8">
              ...
              <h2 className="font-serif text-[1.6rem] md:text-[1.9rem] text-clama-night leading-tight mb-3">
                Sua primeira oração — por nossa conta
              </h2>
              <p className="font-sans text-[0.95rem] text-[#666] leading-relaxed">
